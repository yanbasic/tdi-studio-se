...
/**
 * Adapts a Console's document to the viewer StyledText widget. Allows proper line wrapping of fixed width consoles
 * without having to add line delimiters to the StyledText.
 *
 * By using this adapter, the offset of any character is the same in both the widget and the document.
 *
 * @since 3.1
 */
public class ConsoleDocumentAdapter implements IDocumentAdapter, IDocumentListener {
    ...
    /*
     * repairs lines list from the beginning of the line containing the offset of any DocumentEvent, to the end of the
     * Document.
     */
